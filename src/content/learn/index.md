...
பொத்தான் முதல் முறை காட்டப்படும் போது, நீங்கள் `useState()`-க்கு `0`-ஐப் பாஸ் செய்துள்ளதால், `count` மதிப்பு `0` ஆக இருக்கும். state-ஐ மாற்ற வேண்டுமெனில், `setCount()`-ஐ அழைத்து புதிய மதிப்பைப் பாஸ் செய்யவும். இந்த பொத்தானை சொடுக்குவது கவுண்டரை ஒரு அளவு அதிகரிக்கும்:
